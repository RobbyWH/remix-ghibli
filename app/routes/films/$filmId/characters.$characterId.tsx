...
export let loader: LoaderFunction = async ({ params }) => {
  ...
  // throw new Error("RANDOM ERROR"); // goes to ErrorBoundary component
  // throw new Response("Not Found", { status: 404 }); // goes to CatchBoundary component
